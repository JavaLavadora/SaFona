# 23 — Bou de Pedra: Phase Transition
...
CRITICAL IDENTITY LOCK:
  - Must match the Bou de Pedra Phase 1 MASTER idle sprite EXACTLY
...
ANIMATION DESCRIPTION:
  Single frame: Phase transition — bull roaring/bellowing, head thrown back,
...
RULES:
  - Same identity lock
  - Use all glow colors (amber + orange + bright) to show maximum energy surge
