# 29 — Stone Guardian: Death

> **Reference sprite required:** Attach the Stone Guardian MASTER idle sprite (generated in step 25) as visual reference.
...
CRITICAL IDENTITY LOCK:
  - Must match the Stone Guardian MASTER idle sprite EXACTLY
  - Same stone body, same proportions, same green eyes
  - Same palette (9 colors), no new colors
  - No redesign, no reinterpretation

REFERENCE: [ATTACH THE STONE GUARDIAN MASTER IDLE SPRITE HERE]
...
ANIMATION DESCRIPTION:
  Single frame: Crumbling apart — stone blocks separating, green eye glow fading,
