# 30 — Rival Warrior: Master Idle Sprite

> **Reference sprite required:** Attach the Bou de Pedra Phase 1 MASTER idle sprite (generated in step 14) as world-style reference. The Rival Warrior must match the visual world established by the boss.
...
This is the MASTER reference for the Rival Warrior.
```
