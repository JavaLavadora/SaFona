# 32 — Rival Warrior: Attack

> **Reference sprite required:** Attach the Rival Warrior MASTER idle sprite (generated in step 30) as visual reference.
...
CRITICAL IDENTITY LOCK:
  - Must match the Rival Warrior MASTER idle sprite EXACTLY
  - Same proportions, face, hair, hide armor, club, wrappings
  - Same palette (12 colors), no new colors
  - No redesign, no reinterpretation

REFERENCE: [ATTACH THE RIVAL WARRIOR MASTER IDLE SPRITE HERE]
...
ANIMATION DESCRIPTION:
  Frame 1: Wind-up — club raised overhead, body coiled
  Frame 2: Swing down — club striking forward/down, body extended
