# 36 — Possessed Sheep: Master Idle Sprite

> **Reference sprite required:** Attach the Bou de Pedra Phase 1 MASTER idle sprite (generated in step 14) as world-style reference. Despite being a different creature (sheep vs stone bull), the pixel art style must be indistinguishable.
...
REFERENCE: [ATTACH THE BOU DE PEDRA PHASE 1 MASTER IDLE SPRITE HERE — for world-style consistency]
...
This is the MASTER reference for the Possessed Sheep.
```
