# 40 — Possessed Sheep: Death

> **Reference sprite required:** Attach the Possessed Sheep MASTER idle sprite (generated in step 36) as visual reference.
...
CRITICAL IDENTITY LOCK:
  - Must match the Possessed Sheep MASTER idle sprite EXACTLY
  - Same wool body, same proportions, same red glowing eyes
  - Same palette (8 colors), no new colors
  - No redesign, no reinterpretation

REFERENCE: [ATTACH THE POSSESSED SHEEP MASTER IDLE SPRITE HERE]

PALETTE (use ONLY these 8 colors — RGB values):
...
ANIMATION DESCRIPTION:
  Single frame: Collapsed on side, eyes closed (no longer glowing red),
