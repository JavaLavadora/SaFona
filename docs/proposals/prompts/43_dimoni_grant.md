# 43 — Dimoni de Sant Joan: Grant Power

> **Reference sprite required:** Attach the Dimoni MASTER idle sprite (generated in step 41) as visual reference.
...
CRITICAL IDENTITY LOCK:
  - Must match the Dimoni MASTER idle sprite EXACTLY
  - Same body, same proportions, same horns, same robes
  - Same palette (12 colors), no new colors
  - No redesign, no reinterpretation

REFERENCE: [ATTACH THE DIMONI MASTER IDLE SPRITE HERE]
