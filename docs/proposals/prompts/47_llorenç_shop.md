...
> **Reference sprite required:** Attach the Llorenç MASTER idle sprite (generated in step 45) as visual reference.
...
CRITICAL IDENTITY LOCK:
  - Must match the Llorenç MASTER idle sprite EXACTLY
  - Same proportions, face, beard, shirt, vest, apron, satchel
  - Same palette (12 colors), no new colors
  - No redesign, no reinterpretation

REFERENCE: [ATTACH THE LLORENÇ MASTER IDLE SPRITE HERE]
